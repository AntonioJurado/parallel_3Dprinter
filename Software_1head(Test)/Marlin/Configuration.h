...
#define TEMP_SENSOR_0 9 //Original Extruder 
#define TEMP_SENSOR_1 0 //Modified Extruder
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {66.6066,67.0208,4000,127.0735}  // default steps per unit for Ultimaker
#define DEFAULT_AXIS_STEPS_PER_UNIT   {66.666667,66.666667,2400,130}   //Valores sacados de repetier x400ce !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

//#define DEFAULT_MAX_FEEDRATE          {400, 400, 1, 45}    // (mm/sec)
#define DEFAULT_MAX_FEEDRATE          {200, 200, 5, 12}  //Valores sacados de repetier x400ce !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#define DEFAULT_MAX_ACCELERATION      {900 , 900, 100, 1000}  //Valores sacados de repetier x400ce !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
//
#define REPRAP_DISCOUNT_SMART_CONTROLLER  //DON'T FORGET THIS LINE
